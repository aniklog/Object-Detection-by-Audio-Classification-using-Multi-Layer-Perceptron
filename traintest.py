...
tk.Label(tab1, text="Path for Training the Model : ", font='customFont1', fg="black",
         width=25).grid(columnspan=1, row=1, column=0)
...
tk.Label(tab3, text="Path for Testing the Model : ", font='customFont1', fg="black",
         width=23).grid(columnspan=1, row=2, column=0)
...
browseOFileBtn = tk.Button(tab3, text="Browse Output Folder", command=lambda:browse_outputFile(), font='customFont1', bg="azure", fg="black", height=2, width=18)
...
tk.Label(tab3, text="Signal Ends at Column : ", font='customFont1', fg="black",
         width=20).place(x=500, y=250)
signal_end3 = tk.Entry(tab3, width=5, textvariable=end_column3).place(x=700, y=250)
...
tk.Label(tab2, text="False Negative (FN) :", font='customFont1', fg="black", width = 19).grid(row=5, column=1)
...
tk.Label(tab2, text="False Discovery Rate (FDR) :", font='customFont1', fg="black", width = 24).grid(row=6, column=1)
...
tk.Label(tab2, text="Negative Predictive Value (NPV) :", font='customFont1', fg="black", width = 27).grid(row=7, column=1)
